    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('searchInput').addEventListener('keydown', function(event) {
            if (event.key === 'Enter') {
                ...
                var searchTerm = document.getElementById('searchInput').value; // 입력된 검색어 가져오기
                window.location.href = 'mall_searchlist.jsp?search=' + encodeURIComponent(searchTerm); // 검색 결과 페이지로 이동
            }
        });
    });
</script>
<div align="right" class="top-banner" style="width: 300px; margin-top: 7px;">
	<input type="button" value="일반" class = "purbtn" style="margin-top: 7px;">
	<a style="margin-top: 7px;"><%=id %> </a>
	<a class = "top" href = "mall_cartlist.jsp" style="cursor: pointer; margin-left: 10px; margin-top: 7px;"> 장바구니</a>
	<a style="margin-top: 7px;"> | </a>
	<a class = "top" href = "mall_orderlist.jsp" style="cursor: pointer; margin-top: 7px;">주문목록</a>
	<a style="margin-top: 7px;"> | </a>
	<a href = "../../member/login/login_Form.jsp" style="margin-top: 7px"> 로그아웃 </a>
</div>
<div style="margin-left: 320px; display: flex;">
	<a href="../user/mall.jsp">
	...
	<button class="btn" style="margin-left: 6px; margin-right: 100px;"><font color="#5F0080">마켓컬리 </font></button>
	<input id="searchInput" placeholder="검색어를 입력해주세요" class="pur search">
</div>
<div class = "banner2">
		<span class="menu"><a href = "../user/mall_alllist.jsp">모든상품</a></span>
		<span class="menu"><a href = "../user/mall_bestlist.jsp">베스트</a></span>
		<span class="menu"><a href = "../user/market-sales.jsp">알뜰쇼핑</a></span>
		<span class="menu"><a href = "../user/market-benefit.jsp">특가/혜택</a></span>
		<span class="menu"><a href = "mall_review.jsp">리뷰</a></span>
</div>
<hr style="height: 5px; color: #F4F4F4; margin-top: 15px; background: #F4F4F4; border:none;">

    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('searchInput').addEventListener('keydown', function(event) {
            if (event.key === 'Enter') {
                ...
                window.location.href = '../user/mall_searchlist.jsp?search=' + encodeURIComponent(searchTerm); // 검색 결과 페이지로 이동
            }
        });
    });
</script>
...
<div align="right" class="top-banner" style="width: 300px; margin-top: 7px;">
	<input type="button" value="관리자" class = "purbtn" style="margin-top: 7px;">
	<a style="margin-top: 7px; margin-left: 5px;"><%=id %> </a>
	<a class = "top"   href = "admin_insert_Form.jsp" style="cursor: pointer; margin-left: 10px; margin-top: 7px;"> 물품등록</a>

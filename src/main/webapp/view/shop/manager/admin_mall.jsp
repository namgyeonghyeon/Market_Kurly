...
<div>
	<div>
		<span class="top_banner">💜슈퍼빅세일 기획특가💜 <a href = "../users/market-sales.jsp"><img
...
<div>
	...
	%>	
		<a href = "../user/buy_mall.jsp?pnum=<%=pb.getPnum()%>">
			<img class="img_size" src="<%=imgPath %>" id="firstImage"> 
		</a>
	<%
		} 
	%>
		<a href = "../user/mall_alllist.jsp">
...
<%@ include file="admin_mall_bottom.jsp"%>

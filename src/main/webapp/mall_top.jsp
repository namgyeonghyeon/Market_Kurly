...
<div align="right" class="top-banner">
	<a href = "../register/register_Form.jsp"><font color="#5F0080">회원가입</font> </a>|
...
<div style="margin-left: 320px; display: flex;">
	...
	<input id="gnb_search" placeholder="검색어를 입력해주세요" class="pur search">
</div>
<div class = "banner2">
		<strong>
			<span class="menu">모든상품</span>
			<span class="menu">베스트</span>
			<span class="menu">알뜰쇼핑</span>
			<span class="menu">특가/혜택</span>
		</strong>
</div>
